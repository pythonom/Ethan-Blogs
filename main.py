...
def register():
    ...
    if form.validate_on_submit():
        ...
        secure_pass = generate_password_hash(form.password.data, method='pbkdf2:sha256', salt_length=8)
        new_user = User(email=form.email.data, password=secure_pass, name=form.name.data)
